...
import com.dreampiece.a3cuadras.fragments.FullScreenDialogFragment
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        when (id){
            R.id.navigationPreferences -> {
                ...
                val b = Bundle()
                b.putString("TITLE", "FREMIUM 3Cuadras App")
                b.putString("TEXT", getString(R.string.freemium_info_text))
