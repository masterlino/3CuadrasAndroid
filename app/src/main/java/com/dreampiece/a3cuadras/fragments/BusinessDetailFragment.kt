...
import com.dreampiece.a3cuadras.adapters.PhotosBusinessAdapter
import com.dreampiece.a3cuadras.model.BusinessDetailItem
...
class BusinessDetailFragment: Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(p0: GoogleMap?) {
        if (p0 != null && currentBusinessDetailItem != null) {
            map = p0
            val latitude : Double? = currentBusinessDetailItem?.coordinates?.latitude
            val longitude : Double? = currentBusinessDetailItem?.coordinates?.longitude
